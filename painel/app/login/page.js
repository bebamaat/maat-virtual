  ...
  return (
    <div className="login-shell">
      ...
      <div className="login-card">
        <img src="/logos/maat-horizontal-preto.png" alt="MAAT" className="login-logo" />
        <p className="login-sub">Virtual — Painel Central</p>
        ...
        <p className="login-foot">Somente emails @bebamaat.com.br</p>
      </div>
    </div>
  );
}
