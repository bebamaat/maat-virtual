...
**Núcleo humano**: 4 sócios + 2 representantes (supervisores gerais, ao lado do núcleo).
**Agente-Mestre** (dono: Cleber · transversal) orquestra as 4 áreas.

### (1) Estratégia — dono: Julia

- A. Governança (Julia) → Agente Governança
- B. Planejamento (Julia) → Agente BI (estratégico)
- C. Inteligência Digital (Cleber) → GA4/GTM · Make/n8n
...
- Todo agente tem 1+ dono (humano ou agente).
